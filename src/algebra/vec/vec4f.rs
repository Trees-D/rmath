...
impl Add<f32> for Vec4f {
    ...
    fn add(self, rhs: f32) -> Self::Output {
        Vec4f::new(self.x + rhs, self.y + rhs, self.z + rhs, self.w + rhs)
    }
}
...
impl Add<Vec4f> for f32 {
    ...
    fn add(self, rhs: Vec4f) -> Self::Output {
        Vec4f::new(self + rhs.x, self + rhs.y, self + rhs.z, self + rhs.w)
    }
}
...
impl MulAssign<Vec4f> for Vec4f {
...
impl DivAssign<Vec4f> for Vec4f {
...
impl Index<usize> for Vec4f {
    ...
    fn index(&self, index: usize) -> &Self::Output {
        match index {
            ...
            2 => &self.z,
            3 => &self.w,
            _ => panic!("`rmath::algebra::Vec4f::index`: index out of bounds."),
        }
    }
}
...
impl IndexMut<usize> for Vec4f {
    fn index_mut(&mut self, index: usize) -> &mut Self::Output {
        match index {
            ...
            2 => &mut self.z,
            3 => &mut self.w,
            _ => panic!("`rmath::algebra::Vec4f::index_mut`: index out of bounds."),
        }
    }
}
...
impl Vec4f {
    ...
    pub fn xxz(self) -> Vec3f {
        Vec3f::new(self.x, self.x, self.z)
    }

    pub fn xxw(self) -> Vec3f {
        Vec3f::new(self.x, self.x, self.w)
    }
    ...
    pub fn xyw(self) -> Vec3f {
        Vec3f::new(self.x, self.y, self.w)
    }

    pub fn xzx(self) -> Vec3f {
        Vec3f::new(self.x, self.z, self.x)
    }
    ...
    pub fn xzz(self) -> Vec3f {
        Vec3f::new(self.x, self.z, self.z)
    }

    pub fn xzw(self) -> Vec3f {
        Vec3f::new(self.x, self.z, self.w)
    }

    pub fn xwx(self) -> Vec3f {
        Vec3f::new(self.x, self.w, self.x)
    }

    pub fn xwy(self) -> Vec3f {
        Vec3f::new(self.x, self.w, self.y)
    }

    pub fn xwz(self) -> Vec3f {
        Vec3f::new(self.x, self.w, self.z)
    }

    pub fn xww(self) -> Vec3f {
        Vec3f::new(self.x, self.w, self.w)
    }
    ...
    pub fn yxw(self) -> Vec3f {
        Vec3f::new(self.y, self.x, self.w)
    }
    ...
    pub fn yyz(self) -> Vec3f {
        Vec3f::new(self.y, self.y, self.z)
    }

    pub fn yyw(self) -> Vec3f {
        Vec3f::new(self.y, self.y, self.w)
    }
    ...
    pub fn yzy(self) -> Vec3f {
        Vec3f::new(self.y, self.z, self.y)
    }

    pub fn yzz(self) -> Vec3f {
        Vec3f::new(self.y, self.z, self.z)
    }

    pub fn yzw(self) -> Vec3f {
        Vec3f::new(self.y, self.z, self.w)
    }

    pub fn ywx(self) -> Vec3f {
        Vec3f::new(self.y, self.w, self.x)
    }

    pub fn ywy(self) -> Vec3f {
        Vec3f::new(self.y, self.w, self.y)
    }

    pub fn ywz(self) -> Vec3f {
        Vec3f::new(self.y, self.w, self.z)
    }

    pub fn yww(self) -> Vec3f {
        Vec3f::new(self.y, self.w, self.w)
    }

    pub fn zxx(self) -> Vec3f {
        Vec3f::new(self.z, self.x, self.x)
    }
    ...
    pub fn zxz(self) -> Vec3f {
        Vec3f::new(self.z, self.x, self.z)
    }

    pub fn zxw(self) -> Vec3f {
        Vec3f::new(self.z, self.x, self.w)
    }
    ...
    pub fn zyy(self) -> Vec3f {
        Vec3f::new(self.z, self.y, self.y)
    }

    pub fn zyz(self) -> Vec3f {
        Vec3f::new(self.z, self.y, self.z)
    }

    pub fn zyw(self) -> Vec3f {
        Vec3f::new(self.z, self.y, self.w)
    }

    pub fn zzx(self) -> Vec3f {
        Vec3f::new(self.z, self.z, self.x)
    }

    pub fn zzy(self) -> Vec3f {
        Vec3f::new(self.z, self.z, self.y)
    }

    pub fn zzz(self) -> Vec3f {
        Vec3f::new(self.z, self.z, self.z)
    }

    pub fn zzw(self) -> Vec3f {
        Vec3f::new(self.z, self.z, self.w)
    }

    pub fn zwx(self) -> Vec3f {
        Vec3f::new(self.z, self.w, self.x)
    }

    pub fn zwy(self) -> Vec3f {
        Vec3f::new(self.z, self.w, self.y)
    }

    pub fn zwz(self) -> Vec3f {
        Vec3f::new(self.z, self.w, self.z)
    }

    pub fn zww(self) -> Vec3f {
        Vec3f::new(self.z, self.w, self.w)
    }

    pub fn wxx(self) -> Vec3f {
        Vec3f::new(self.w, self.x, self.x)
    }

    pub fn wxy(self) -> Vec3f {
        Vec3f::new(self.w, self.x, self.y)
    }

    pub fn wxz(self) -> Vec3f {
        Vec3f::new(self.w, self.x, self.z)
    }

    pub fn wxw(self) -> Vec3f {
        Vec3f::new(self.w, self.x, self.w)
    }

    pub fn wyx(self) -> Vec3f {
        Vec3f::new(self.w, self.y, self.x)
    }

    pub fn wyy(self) -> Vec3f {
        Vec3f::new(self.w, self.y, self.y)
    }

    pub fn wyz(self) -> Vec3f {
        Vec3f::new(self.w, self.y, self.z)
    }

    pub fn wyw(self) -> Vec3f {
        Vec3f::new(self.w, self.y, self.w)
    }

    pub fn wzx(self) -> Vec3f {
        Vec3f::new(self.w, self.z, self.x)
    }

    pub fn wzy(self) -> Vec3f {
        Vec3f::new(self.w, self.z, self.y)
    }

    pub fn wzz(self) -> Vec3f {
        Vec3f::new(self.w, self.z, self.z)
    }

    pub fn wzw(self) -> Vec3f {
        Vec3f::new(self.w, self.z, self.w)
    }

    pub fn wwx(self) -> Vec3f {
        Vec3f::new(self.w, self.w, self.x)
    }

    pub fn wwy(self) -> Vec3f {
        Vec3f::new(self.w, self.w, self.y)
    }

    pub fn wwz(self) -> Vec3f {
        Vec3f::new(self.w, self.w, self.z)
    }

    pub fn www(self) -> Vec3f {
        Vec3f::new(self.w, self.w, self.w)
    }
